...
CREATE TABLE `users_likes` (
  ...
  `id_whom` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `id_who` (`id_who`),
  KEY `id_whom` (`id_whom`),
  CONSTRAINT `users_likes_ibfk_1` FOREIGN KEY (`id_who`) REFERENCES `user` (`id`),
  CONSTRAINT `users_likes_ibfk_2` FOREIGN KEY (`id_whom`) REFERENCES `user` (`id`)
...
INSERT INTO `users_likes` VALUES (1,1,4),(2,4,1),(3,2,4),(4,5,2),(5,6,1),(6,1,6),(7,1,3);
